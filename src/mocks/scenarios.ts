...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    state: {
      ...
      currentPerformance: {
        id: 'p1',
        commandId: 'sound_silence',
        label: COMMAND_BY_ID.sound_silence!.label,
        emoji: COMMAND_BY_ID.sound_silence!.emoji,
      ...
      activityFeed: [
        { id: 'a1', at: now(), text: 'Cue: \u{1F92B} Quiet', tone: 'spotlight' },
